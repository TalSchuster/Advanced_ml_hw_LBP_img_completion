...
n, m = (107-91, 94-12)  # The missing segment plus its neighbors.
image_segment = image[91:107, 12:94]  # here a segment of the original image should be taken
# build grid:
g, V = build_grid_graph(n, m, image_segment)
# process grid:
